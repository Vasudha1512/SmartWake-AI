...
export default function AlarmOverviewCard({
  ...
  return (
    <section
      ...
      className="rounded-2xl bg-white border border-slate-200 p-6 flex flex-col justify-between shadow-xs"
    >
      <div className="flex items-center justify-between gap-4 mb-4">
        <h2 id="alarm-overview-heading" className="text-base font-semibold text-slate-900">
          Alarm Overview
        </h2>
        <span
      ...
      {!hasAlarms ? (
        ...
        <div className="grid grid-cols-2 gap-4 py-2">
          ...
          <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
            ...
            <span className="text-sm font-semibold text-indigo-700 block truncate">
          ...
          <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
            ...
            <span className="text-sm font-semibold text-purple-700 block truncate">

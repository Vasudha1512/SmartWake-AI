...
export default function ChallengePreview({ onContinue, isSubmitting = false }) {
  return (
    <div className="space-y-4 pt-4 border-t border-slate-200">
      <div className="p-5 rounded-2xl bg-gradient-to-br from-indigo-50/70 via-white to-slate-50 border border-indigo-100 space-y-3 shadow-xs">
        <div className="flex items-center gap-2 text-indigo-600">
          <span className="p-1.5 rounded-lg bg-indigo-100/60 border border-indigo-200">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
          </span>
          <span className="text-xs font-bold uppercase tracking-wider text-indigo-700">Next Step: Cognitive Challenge</span>
        </div>

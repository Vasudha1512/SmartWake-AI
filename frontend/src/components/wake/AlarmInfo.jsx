...
export default function AlarmInfo({ alarmDraft = null }) {
  if (!alarmDraft) {
    return (
      <div className="p-6 rounded-2xl bg-slate-900/60 border border-dashed border-slate-700/80 text-center space-y-3">
        ...
        <div className="space-y-1">
          <h3 className="text-sm font-semibold text-white">No Active Session Data Received</h3>
        ...
        <div className="pt-2 flex flex-wrap justify-center gap-3">
          ...
          <Link
            to="/challenge"
            className="px-3.5 py-1.5 rounded-lg text-xs font-semibold text-slate-300 bg-slate-800 hover:bg-slate-700 transition-colors border border-slate-700"
          >
            Select Challenge
          </Link>
        </div>
  ...
  return (
    <div className="p-5 rounded-2xl bg-slate-900/60 border border-slate-800 shadow-md">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
        <div className="space-y-1">
          <span className="text-slate-400 block">Triggered Alarm</span>
        ...
        <div className="space-y-1">
          <span className="text-slate-400 block">Alarm Label</span>
        ...
        <div className="space-y-1">
          <span className="text-slate-400 block">Challenge Required</span>
